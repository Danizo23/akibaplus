<x-app-layout>
    ...
    <x-dashboard-shell title="Customer Management" description="View customers and edit their contact information." icon="👥">
        <div class="bg-white/10 backdrop-blur-md overflow-hidden rounded-3xl shadow-xl p-6 mb-6">
