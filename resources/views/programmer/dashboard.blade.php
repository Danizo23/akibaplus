        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <!-- System Status Card -->
                    <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-cyan-400/30 transform transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:bg-white/20 relative overflow-hidden group">
                        <div class="relative z-10">
                    ...
                    <!-- Add Staff Card -->
                    <div class="rounded-2xl p-6 shadow-xl border border-cyan-400/50 transform transition duration-300 hover:-translate-y-1 hover:shadow-2xl flex flex-col justify-center items-center text-center"
                ...
                <div class="bg-white/10 backdrop-blur-md overflow-hidden rounded-2xl border border-cyan-400/30 shadow-xl">
                    <div class="px-6 py-5 border-b border-cyan-400/30">
