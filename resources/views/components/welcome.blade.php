<div class="p-6 lg:p-8 bg-white dark:bg-transparent dark:bg-gradient-to-bl dark:from-blue-700/20 dark:via-transparent border-b border-gray-200 dark:border-white/10 relative z-10">
...
<div class="bg-gray-200 dark:bg-transparent grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8 relative z-10">
    <div>
