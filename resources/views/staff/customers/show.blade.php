<x-app-layout>
    ...
    <x-dashboard-shell title="Customer Details" description="View customer savings profile and transaction history." icon="👤">
        ...
        <div class="text-right">
            <a href="{{ route('staff.customers.index') }}" class="inline-flex items-center gap-2 rounded-2xl bg-cyan-600 px-6 py-3 text-sm font-semibold text-white hover:bg-cyan-500">← Back to customers</a>
        </div>
    </x-dashboard-shell>
</x-app-layout>
